        ...
        <article id="property__article">
            ...
            <form onSubmit={handleFormSubmit} id="property__form">
                ...
                <div id="form__fields">
                    ...
                    <label className="label price__label">price<span className="colorme">*</span><br /><input type="number" name="price" className="fields price__field" placeholder="enter price" /></label>

                    <label className="label description__label span__">description<span className="colorme">*</span><br /><textarea name="descriptionField" className="fields description__field" placeholder="enter description" /></label>
